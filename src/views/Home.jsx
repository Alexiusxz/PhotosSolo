      ...
      <section className="py-5">
        <div className="container">
          <div className="row filtr-container">
            <div className="col-md-6 col-lg-4 filtr-item" data-category="2,3" style={{ width: '30%' }}>
              <div className="card border-dark">
                <div className="card-header bg-dark text-light">
                  <h5 className="m-0"><a href="#tag">tag</a></h5>
                </div>
                <img className="img-fluid card-img w-100 d-block rounded-0" src="db img" alt="tag" />
                <div className="card-body"><a href="user.name">user name</a></div>
