        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navcol-1">
            <ul className="navbar-nav mx-auto">
              ...
              <li className="nav-item"><a className="nav-link active" href="/signup">Регистрация</a></li>
              ...
              <div className="card">
                <div className="card-body text-center d-flex flex-column align-items-center" style={{ backgroundColor: '#dee2e6' }}>
                  ...
                  <form name="signUpForm">
                    ...
                    <div className="mb-3"><button className="btn btn-primary shadow d-block w-100" type="submit">Зарегистрироваться</button></div>
